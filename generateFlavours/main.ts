  ...
  const theme: JBTheme = {
    ...
    ui: {
      ...
      List: {
        ...
        hoverInactiveBackground: "selectionInactiveBackground",
      },
      Borders: {
      ...
      VersionControl: {
        ...
        Log: {
          Commit: {
            ...
            currentBranchBackground: "mantle",
            selectedBranchBackground: "mantle",
          },
        },
        RefLabel: {
          foreground: "primaryForeground",
    ...
    icons: {
      ColorPalette: {
        ...
        "Checkbox.Foreground.Disabled": colors.surface1,
